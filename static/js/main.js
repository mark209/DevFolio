...
// Reveal cards on scroll with minimal animation.
  ...
  projects.forEach((project) => {
    ...
    card.innerHTML = `
      <div class="project-image">
        ${isImage ? `<img src="/static/${screenshot}" alt="${project.title} screenshot" loading="lazy" />` : `<span>${screenshot || 'Screenshot placeholder'}</span>`}
      </div>
      <div>
        <h3>${project.title}</h3>
